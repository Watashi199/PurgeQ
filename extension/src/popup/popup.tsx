...
const PopupApp: React.FC = () => {
  ...
  async function handleSignIn() {
    ...
    try {
      setAuthLoading(true);
      // Opens the hosted auth page (auth-page/) which runs Turnstile +
      // Discord OAuth on a real domain Cloudflare accepts, then bounces
      // back to chromiumapp.org so the extension can capture the session.
